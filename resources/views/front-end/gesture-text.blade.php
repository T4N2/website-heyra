...
@section('gesture-text')
    <section id="hero" class="clearfix">
        <div class="container" data-aos="fade-up">

            <div class="hero-info" data-aos="zoom-out" data-aos-delay="100">
                <h2>Teknologi Penerjemah<br>Bahasa Isyarat<br><br>Gesture to Text</h2>
                <div>
            ...
            <div class="hero-img" data-aos="zoom-in" data-aos-delay="200">
                <img src="assets/img/fitur2.png" alt="" class="img-fluid" width="400px">
            </div>
        </div>
              ...
              <div class="container" data-aos="fade-up">
                ...
                <div class="row about-container">
                  ...
                  <div class="col-lg-6 content order-lg-1 order-2">
                    <h1 style="text-align: center; margin-bottom:100px;">Pencarian</h1>
                    <div class="search-container">
                      <input class="search-input" type="text" placeholder="Cari sesuatu..." />
                      <button class="search-button">Cari</button>
                  </div> -->
    <!-- <p>
                      Kami menawarkan teknologi penerjemah bahasa isyarat Indonesia kepada teman-teman yang mengalami gangguan pendengaran. Teknologi ini dapat membantu mereka berkomunikasi lebih efektif menggunakan bahasa isyarat.
                    </p> -->
    ...
    <section id="services" class="section-bg">
        <div class="container" data-aos="fade-up">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-12 col-lg-10" data-aos="zoom-in" data-aos-delay="100">
                    <div class="box">
                        <p></p>
                    </div>
                </div>

                <div class="col-md-3 col-lg-4" data-aos="zoom-in" data-aos-delay="100">
                    <div class="box">
